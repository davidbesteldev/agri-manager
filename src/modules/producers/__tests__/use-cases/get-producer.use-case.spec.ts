...
import { GetProducerUseCase } from '@app/modules/producers/use-cases'
...
describe('GetProducerUseCase', () => {
  ...
  beforeAll(async () => {
    ...
    sut = module.get<GetProducerUseCase>(GetProducerUseCase)
  })
  ...
  it('should execute successfully', async () => {
    ...
    const result = await sut.execute(producerId)
